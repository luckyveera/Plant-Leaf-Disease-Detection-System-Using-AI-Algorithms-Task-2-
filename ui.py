...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/task(2)/PlantDiseaseDetection/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/task(2)/PlantDiseaseDetection/testpicture"
